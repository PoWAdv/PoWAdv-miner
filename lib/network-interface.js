...
module.exports =  {
  ...
  async sendMiningSolutions()
    ...
    async collectMiningParameters(minerEthAddress)
    {
	  ...
	  //POWA
	  var tokenbalance = await this.tokenContract.methods.balanceOf(minerEthAddress).call();

	  var discounttargetString = await this.tokenContract.methods.discountedMiningTarget(minerEthAddress).call();
	  
	  var discounttarget = web3Utils.toBN(discounttargetString);
	  
      return {
        miningDifficulty: miningDifficulty,
        challengeNumber: challengeNumber,
        miningTarget: discounttarget,
  ...
  try{
	...
	*/
    ...
    const txOptions = {
      ...
      gas: web3Utils.toHex(max_gas_cost),   //? POWA
